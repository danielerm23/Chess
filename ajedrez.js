...
const tBlancas = document.getElementById("tiempo-blancas")
const tNegras = document.getElementById("tiempo-negras")
...
function nombre (){
    ...
    document.getElementById('boton-nombre-jugador').addEventListener('click', () => {
        ...
        if (nombre!==""){
            ...
            document.getElementById('input-nombre').placeholder="Vacío"
        }
    })
}
